/*#info 
	...
	# Detalhes 
		Gera o create index dos índices de um banco ou tabela específica.
		Não fui eu que criei o script, mas é bem útil e por isso guardei aqui.
		Ajustes os filtros no final, antes de rodar!
*/
...
WHERE 
    ...
    and
	-- filtros: Tabela. Se quiser tudo, comente.
