/*#info 
	...
	# Detalhes 
		Ler os eventos da sessão TraceCheckpoints do extended events 
...
--select PBM_PRODUCAO from #TargetData
--select PBM_PRODUCAO from #Eventos;
--return;
...
ORDER BY
	...
	--select PBM_PRODUCAO from #Eventos where CONVERT(datetime,ContextInfo) = '2014-08-25 18:20:57.460'
