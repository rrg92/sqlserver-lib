...
if object_id('dbo.Recover_Deleted_Data_Proc') is null
	EXEC('CREATE PROCEDURE dbo.Recover_Deleted_Data_Proc AS SELECT 1 StubVersion')
GO

ALTER PROCEDURE dbo.Recover_Deleted_Data_Proc
@Database_Name NVARCHAR(MAX),
@SchemaName_n_TableName NVARCHAR(Max),
@Date_From DATETIME='19000101',
@Date_To DATETIME ='99991231'
AS
...
CASE
 ...
 WHEN system_type_id = 40 Then CONVERT(varchar(max),CONVERT(date,CONVERT(binary(3),hex_Value))) --DATE
