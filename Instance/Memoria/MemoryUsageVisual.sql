/*#info 
    ...
    # descricao
        A saída dessa query é espetacular!
        Ele mostra visualmente os diversos omcponentes do sql e como se relacionam no uso de memóroa...
        da pra enxergar bem a distribuição de memória no sql!

        Inclusive, esse cara tem um repo sinsitro com coisa de SQL...
